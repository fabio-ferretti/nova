...
#Aggiunto order_by(desc(sort_value))
@require_admin_context
def _service_get_all_topic_subquery_desc(context, session, topic, subq, label):
...
#Modificata per ordinare i nodi dal piu occupato al meno occupato 
@require_admin_context
def service_get_all_compute_sorted_desc(context):
    session = get_session()
    with session.begin():
        ...
        subq = model_query(context, models.Instance.host,
                       ...
                       subquery()
        return _service_get_all_topic_subquery_desc(context,
                                               session,
                                               topic,
                                               subq,
                                               label)
